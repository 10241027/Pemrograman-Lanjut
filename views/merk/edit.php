...
<div class="page-content">
    <h2 align="center">✏️ Edit Data Merk</h2>

    <form method="POST" class="form-box">
        <label>Nama Merk:</label>
        <input type="text" name="merk" value="<?= $merk['merk'] ?>" required>

        <label>Nama Perusahaan:</label>
        <input type="text" name="nama_perusahaan" value="<?= $merk['nama_perusahaan'] ?>" required>
